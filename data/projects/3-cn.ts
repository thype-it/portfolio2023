export const projectContent3: StoryContentData = [
  ...
  },
  {
    ...
    textArray: [
      "My main role involved contributing to the creation of a new feature designed to streamline the management of company business trips. In its initial phase, the steps included the creation of a trip, utilizing all internal data, which would then go through an approval workflow with the product manager. It also automated the distribution of emails to the relevant employees and recorded the details of each business trip in their individual system accounts.",
    ],
  },
  {
    textArray: [
      "Additionally, it offered the flexibility to edit personal records of business trips and generate PDFs containing all the trip details. Which could be then used for handling tasks such as compensating employees for their business trip expenses.",
  ...
  },
  {
    ...
    textArray: [
      ...
      "For the majority of the project, I focused on developing new UI features - paragraphs and adding, editing, and sorting corresponding elements accordingly. I also connected paragraphs to the backend, ensuring the data structure was sound, and the data was processed and displayed correctly. I communicated with the backend team to establish the appropriate data structure for the paragraphs, as I was already creating the types for the mock data to be handled by the final component. Additionally, it was my responsibility to create the appropriate .story files for the new paragraphs to be fully interactive in Storybook.",
    ],
  },
  {
    image: {
    ...
    text: "Cost calculator used for estimating the cost of a project - one of the features I was resposible for.",
  },
  {
    title:
