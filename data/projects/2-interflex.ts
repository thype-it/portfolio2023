export const projectContent2: StoryContentData = [
  ...
  {
    title: "Main focus and my responsibilities",
  ...
  {
    textArray: [
      "My main role was to implement features by creating new UI elements with React Native, incorporating all essential accessibility features, and connecting them to real data. This also required close collaboration with the backend team to structure the necessary data.",
      "Given the complexity of the existing data structures and systems, a weekly meeting was held, where I, as a member of the frontend team, was expected to have a deep understanding of the app's structure and proposed functionalities, primarily referencing detailed Figma files. During these discussions, I provided valuable input when needed.",
      "Additionally, I was responsible for providing a weekly presentation of the frontend team's progress to the rest of the team and client representatives.",
    ],
  },
  {
    image: {
